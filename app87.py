...
# Replace with your WhatsApp number (Country code + phone number)
# Example format: "967712345678" or "15551234567" (NO +, NO spaces, NO dashes)
...
if products:
    ...
    st.info("No products listed yet.")import os
import json
import streamlit as st
